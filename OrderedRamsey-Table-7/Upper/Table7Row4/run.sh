...
echo '0 1 0 1  0 1 1  1 0  0' > zippedn$1/forbidden_graph.txt

# Generate colored cliques containing a monochromatic copy of forbidden graph
python3 ../general_generate.py  '0 1 0 1  0 1 1  1 0  0' > F_ordered_edges3__forbidden.txt

# Forbidden graphs creating blow-up structre
...
# Round the solution
echo "Start Rounding"
sage round.sage $1 &> zippedn$1/rounding_log_$1.txt
